...
| 4 | Long tweets (250–750 words) | Default `TWEET_MODE=long`; **requires X Premium on the bot account** (any Premium tier; long posts allow up to 25k chars). If X rejects the long post, the bot automatically re-posts the short format |
...
### 1 · X Premium on the BOT account (for long posts)
Long-form posts are an X Premium feature **of the posting account** — your
personal subscription doesn't transfer. Subscribe the bot account to any
Premium tier (Basic is enough for >280-char posts). Skip this and the bot
simply keeps posting the short format via the automatic fallback.
...
TWEET_MODE       (long)     long | short
ATTACH_GAUGE     (true)     attach the daily gauge card
...
LONG_MIN_WORDS   (250)   LONG_MAX_WORDS (750)   MAX_LONG_CHARS (6000)
...
|---|---|---|
| X post create (text/media, no URL) | $0.015 | **~$0.47** |
| X Premium on bot account (long posts) | from ~$3–8/mo tier | **$3–8** |
